...
Complete the `styles.css` file such that `index.html` looks **exactly** as shown on `output.png`.  These files can be found in your private GitHub repository (replace `{username}` with your GitHub user in `https://github.com/dat310-spring20/{username}-assignments`).
